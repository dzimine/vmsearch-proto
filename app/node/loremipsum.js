...
var getLoremWord = exports.getLoremWord = function (){
   return loremLang[Math.floor(Math.random()*loremLang.length)];
}

/* returns a random lorem word */
var getLoremWordCap = exports.getLoremWordCap = function (){
   return capitalize(loremLang[Math.floor(Math.random()*loremLang.length)]);
}
...
var loremIpsumSentence = exports.loremIpsumSentence = function (numWords){
   return capitalize(getLoremWord())
         + " "
...
// Quick and dirty "try it out" TO DO ONE DAY: proper  unit tests
//console.log(getLoremWord(100));
//console.log(loremIpsum(100));
//console.log(loremIpsumSentence(100));
//console.log(loremIpsumSentence2(100));
//console.log(loremIpsumParagraph(100));